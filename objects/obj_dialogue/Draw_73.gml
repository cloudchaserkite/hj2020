...
draw_text_ext_transformed(camera_get_view_x(view_camera[0])+(480/2),camera_get_view_y(view_camera[0])+270-(270/8)+16, string_hash_to_newline("Left-Click to Continue"),3,1280,.3,.3,0);//draw the text at the coordinates
