...
draw_text_ext_transformed_colour(camera_get_view_x(view_camera[0])+(480/2),camera_get_view_y(view_camera[0])+270-(270/8), "I found a " + string(itemName) + ", do I want it?",3,1280,.4,.4,0,c_white,c_white,c_white,c_white,1); //draw the text at the coordinates
